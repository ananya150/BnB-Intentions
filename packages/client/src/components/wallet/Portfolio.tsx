  ...
  return (
    <div className="h-full w-full bg-[#F3EF52] rounded-2xl py-6 px-6 flex flex-col justify-between">
        ...
        <div className="flex flex-col space-y-8">
            <div className="text-[13px] font-satoshi">This wallet is a proof of concept for Intents Architecture with Account Abstraction and is meant for testing purposes only.</div>
            <div className="w-full flex justify-center">
                <button className="w-2/3 rounded-3xl py-4 text-white bg-black">WORKING</button>
            </div>
        </div>
    </div>
  );
